...
function [ori_longitude, ori_latitude] = cal_ori_lat_and_long(theta0, LaneRadarTrack1, LaneRadarTrack2, LaneRadarTrack3, dirLane2EastFlage)
    R = 6371393;   % 地球平均半径
    ...
    for i = 1 : n_Lane1
        ...
        ori_coordinate1(i, 1) = LaneRadarTrack1(i, 5) + dirLane2EastFlage * westDeg;
        ori_coordinate1(i, 2) = LaneRadarTrack1(i, 4) + dirLane2EastFlage * southDeg;
    end
    for i = 1 : n_Lane2
        ...
        ori_coordinate2(i, 1) = LaneRadarTrack2(i, 5) + dirLane2EastFlage * westDeg;
        ori_coordinate2(i, 2) = LaneRadarTrack2(i, 4) + dirLane2EastFlage * southDeg;
    end
    for i = 1 : n_Lane3
        ...
        ori_coordinate3(i, 1) = LaneRadarTrack3(i, 5) + dirLane2EastFlage * westDeg;
        ori_coordinate3(i, 2) = LaneRadarTrack3(i, 4) + dirLane2EastFlage * southDeg;
    end
